...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/14 08:37:04 by phil              #+#    #+#             */
/*   Updated: 2022/01/14 08:37:04 by phil             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	game.window = mlx_new_window(game.mlx, (MAP_X) * TILE,
			MAP_Y * TILE, "Repair Your Boat");
	MAP_Y = 0;
	MAP_X = 0;
	ft_createmap(game);
...
void	ft_free_image(t_mainstruct game)
{
	...
	if (game.imgs->collectables != NULL)
		mlx_destroy_image(game.mlx, game.imgs->collectables);
